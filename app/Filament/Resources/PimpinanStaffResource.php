        ...
        return $form
            ->schema([
                ...
                Forms\Components\Select::make('status')
                    ->options([
                        'Kepala Program Studi Desain Interior' => 'Kepala Program Studi Desain Interior',
                        'Dosen' => 'Dosen',
                        'Staff' => 'Staff',
                    ])
                    ->reactive()
                ...
                Forms\Components\RichEditor::make('kata_sambutan')
                    ->visible(fn (Get $get) => $get('status') === 'Kepala Program Studi Desain Interior') 
                    ->required(fn (Get $get): bool => $get('status') === 'Kepala Program Studi Desain Interior')
                    ->columnSpanFull()
                    ->label('Kata Sambutan'),
